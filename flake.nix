    ...
    let
      ...
      perSystemPackages = forAllSystems (pkgs: system:
        let
          ...
          # This happens in a separate derivation with network access
          bunLockGen = pkgs.stdenv.mkDerivation {
            ...
            # Allow network access to fetch packages
            __impure = true;
          ...
          # Step 3: Build the complete project with bun2nix offline cache
